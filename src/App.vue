<template>
  <div>
    ...
    <div v-if="this.$globalState.loader" class="loader-wrapper">
      <div class="loader">
        <div></div>
        <div></div>
        <div></div>
    ...
    <div :class="this.$globalState.loader ? 'blur_page' : ''">
          ...
          <div class="" :class="collapse_active == true ? 'active' : ''">
            <div class="account-navigation" :class="collapse_active == true ? 'active' : ''">
              ...
              <div class="nav-header" @mouseover="showEditProfile = true" @mouseleave="showEditProfile = false" style="padding: 0px 10px; height: 80px">
                ...
                <div style="max-width: 40px; max-height: 80px; display: inline-flex;" :style="collapse_active == true ? '' : 'margin-right: 0rem;'" v-if="user.image" class="company-logo-tiers">
                    <img :src="user.image" alt="User Image" />
                </div>
                <div v-else style="max-width: 40px; max-height: 80px; display: inline-flex; margin-left: 0.5rem; margin-right: 1.3rem; font-size: 28px;" :style="collapse_active == true ? '' : 'margin-right: 0rem;'" class="company-logo-tiers fal fa-user"></div>
                </label>
              ...
              <aside class="menu">
                <ul class="menu-list">
                  ...
                  <li :title="'Statistiques'" :class="user.allowed_routes && user.allowed_routes.length > 0 && user.allowed_routes.includes('products') ? '' : 'notyet'">
...
export default {
  ...
  computed: {
    loaderstatus () {
      return this.$globalState.loader;
    },
    user () {
