            ...
            <div class="" style="flex-basis: 50%;">
              <div data-v-65e9c1a5="" class="autocomplete control">
                <div class="control has-icons-right is-clearfix">
                  <input :title="'Liste de prix'" @blur="hideMenuIPBX" @focus="showMenuIPBX = true" v-model="searchIPBX" type="text" class="form-control" style="pointer: cursor; background-color: transparent;" placeholder="IPBX">
