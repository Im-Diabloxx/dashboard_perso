          ...
          <div class="dashboard-page">
            <div class="sidesWrapper">
              <div class="analyticsSide">
                ...
                <div class="row">
                  <div xs="12" class="col-lg col-xl">
                    <div class="pb-xlg h-100 position-relative">
                      <section class="h-100 mb-0 widget position-relative" style="padding:0; overflow: hidden; height: auto;">
                        <div id="slider" class="slider-container">
                          <img 
                            v-for="(image, index) in images" 
                            :key="index" 
                            :src="image" 
                            class="img-fluid w-100 slide-image"
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "/static/img/baniere1.png",
        "/static/img/baniere2.png"
      ],
      currentSlide: 0
    };
  },
