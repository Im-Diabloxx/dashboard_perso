...
function getGeneralInfo(log: object) {
  let general = {
    ...
    date: Vue.prototype.$dayjs.unix(log.unix_time).locale('FR-fr').format('DD-MM-YYYY'),
    time: Vue.prototype.$dayjs.unix(log.unix_time).locale('FR-fr').format('HH:mm:ss'),
    type: log.type,
    sda: log.sda,
    ctx: log.ctx,
  }
...
const actions: ActionTree<State, any> = {
  ...
  async fetchSubsidiaries({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/subsidiaries?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchGroups({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/groups?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchUsers({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/users?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchServers({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/servers?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchPhones({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/phones?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchMaterials({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/materials?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchQueues({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/queues?session_id=${sessionId}&cn=${cn}`);
  ...
  async fetchSdas({ commit, getters, state }) {
    ...
    const cn = state.cn;
    try {
      const response = await Vue.prototype.$axios.get(`${process.env.ODOO_API}api/v2/ipbx/sdas?session_id=${sessionId}&cn=${cn}`);
  ...
  async GET_CONTACTS({commit, state}) {
    ...
    await Vue.prototype.$axios.get(url, { headers: header })
      .then((response: {
          data: any[];
      }) => {
